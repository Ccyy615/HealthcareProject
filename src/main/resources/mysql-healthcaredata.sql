...
VALUES
    (1, 'e1f2a3b4-c5d6-47e8-9f01-23456789abcd', '123 Main St', 'Montreal', 'Quebec', 'H1A2B3', 'OPEN', TRUE, 30),
    (2, 'f2a3b4c5-d6e7-48f9-0a12-3456789bcdef', '456 Elm St', 'Laval', 'Quebec', 'H7B4C5', 'OPEN', TRUE, 20),
    (3, 'a3b4c5d6-e7f8-49a0-1b23-456789abcdef', '789 Pine St', 'Toronto', 'Ontario', 'M5C1A1', 'OPEN', TRUE, 40);
...
VALUES
    (1, 'c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c6', 'e1f2a3b4-c5d6-47e8-9f01-23456789abcd', 1,
     'IN_PROGRESS', '2026-03-16 10:00:00', '2026-03-18 09:00:00', '2026-03-18 09:30:00', 'General check-up');

INSERT INTO appointments(appointment_id, patient_id, doctor_id, clinic_id,
                         appointment_status, created_at, appointment_start, appointment_end, descriptions)
VALUES (2, 'c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b9a2', 'f2a3b4c5-d6e7-48f9-0a12-3456789bcdef', 2,
        'IN_PROGRESS', '2026-03-16 10:05:00', '2026-03-18 10:00:00', '2026-03-18 10:20:00', 'Follow-up consultation');

INSERT INTO appointments(appointment_id, patient_id, doctor_id, clinic_id,
                         appointment_status, created_at, appointment_start, appointment_end, descriptions)
VALUES(3, 'e3f4a5b6-c7d8-e9f0-a1b2-c3d4e5f6a7b8', 'a3b4c5d6-e7f8-49a0-1b23-456789abcdef', 3,
       'COMPLETED', '2026-03-16 10:10:00', '2026-03-17 14:00:00', '2026-03-17 14:40:00', 'Routine blood pressure check');

INSERT INTO appointments(appointment_id, patient_id, doctor_id, clinic_id,
                         appointment_status, created_at, appointment_start, appointment_end, descriptions)
VALUES(4, 'f4a5b6c7-d8e9-f0a1-b2c3-d4e5f6a7b8c9', 'e1f2a3b4-c5d6-47e8-9f01-23456789abcd', 1,
       'CANCELLED', '2026-03-16 10:15:00', '2026-03-19 11:00:00', '2026-03-19 11:30:00', 'Patient cancelled due to illness');

INSERT INTO appointments(appointment_id, patient_id, doctor_id, clinic_id,
                         appointment_status, created_at, appointment_start, appointment_end, descriptions)
VALUES (5, 'a5b6c7d8-e9f0-a1b2-c3d4-e5f6a7b8c9d0', 'a3b4c5d6-e7f8-49a0-1b23-456789abcdef', 3,
